...
public class AutoFragment extends Fragment {
    ...
    @BindView(R.id.seekbar_auto)
    IndicatorSeekBar mSeekbarAuto;
    ...
    private void initView() {
        ...
        mSeekbarAuto.setOnSeekBarChangeListener(new IndicatorSeekBar.OnIndicatorSeekBarChangeListener() {
            @Override
